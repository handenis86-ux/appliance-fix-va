...
export default async function IceMachineRepairPage() {
  const data = await getService("ice-machine");
  const problems = data.problems;
  const features = data.features.items;
  const machineTypes = data.types;
  ...
  return (
    <>
      ...
      <main className="flex-1">
        ...
        {/* CTA - Need Ice Machine Fixed */}
        <section className="pb-16">
          <div className="max-w-[1160px] mx-auto px-6">
            <div className="bg-blue-light border border-blue-border rounded-xl p-8 text-center">
              <h3 className="text-xl sm:text-2xl font-bold text-slate-900 mb-2">Need your ice machine repaired today?</h3>
        ...
        {/* TYPES & PARTS */}
        {(machineTypes.length > 0 || parts.length > 0) && (
