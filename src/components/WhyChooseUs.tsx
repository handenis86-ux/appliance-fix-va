...
import type { HomeWhyItem } from "@/lib/content";
...
// Icon fallbacks by index (3 items currently).
const icons: ReactNode[] = [
  (
    <svg key="clock" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="10" />
      <polyline points="12 6 12 12 16 14" />
    </svg>
  ),
  (
    <svg key="shield" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
    </svg>
  ),
  (
    <svg key="bolt" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const defaultData: WhyChooseUsData = {
  ...
  items: [
    ...
    },
    {
      ...
      description:
        "We know you're busy, which is why our technicians arrive with fully stocked trucks. This means we can diagnose and fix nearly any appliance issue on the spot, saving you stress, time, and money. No more waiting for days for parts to arrive — we get it done right the first time.",
      image: "/why-3.png",
      imagePosition: "right",
    },
  ],
...
export default function WhyChooseUs({ data = defaultData }: WhyChooseUsProps) {
  return (
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <p className="text-[14px] text-slate-500 leading-[1.7]">{item.description}</p>
                </div>
              </div>
            );
          })}
