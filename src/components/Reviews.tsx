      ...
      <div className="max-w-[1160px] mx-auto px-6">
        <div className="text-center mb-8">
          <h2 className="text-[clamp(1.4rem,2.8vw,1.85rem)] font-bold text-slate-900 mb-2.5">
            Real Stories From Our Customers In Arlington
          </h2>
          <p className="text-[15px] text-slate-500 max-w-[520px] mx-auto">
            Fast and Reliable Appliance Repairs backed by real local reviews
          </p>
        </div>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3.5">
          {reviews.map((r) => (
            <div key={r.author} className="bg-white rounded-[10px] p-5 border border-slate-200">
